...
import CartTotel from '../compontents/CartTotel'
    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          ...
          <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Contry' />
        </div>
        ...
        <div className='mt-12'>
          ...
          <div className='flex flex-col gap-3 lg:flex-row'>
            ...
            <div onClick={()=>setMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer rounded-lg'>
              ...
              <p className='text-gray-700 text-sm mx-4 font-medium'>CASH ON DELIVERY</p>
            </div>
          </div>
          <div className='w-full text-end mt-8'>
              <button onClick={()=>navigate('/orders')} className='text-sm rounded-md bg-black text-white px-16 py-3'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
